...
ActiveRecord::Schema[7.0].define(version: 2022_11_01_195113) do
  ...
  create_table "businesses", force: :cascade do |t|
    ...
    t.index ["favorite_id"], name: "index_businesses_on_favorite_id"
  end
  ...
  add_foreign_key "businesses", "favorites"
